...
export class AdminResource {
  ...
  private headers(): Record<string, string> {
    if (!this.adminKey) {
      throw new AuthenticationError(
        "Admin key is required for admin endpoints. Provide `adminKey` in SpooledClient config.",
      );
    }
  ...
  async createOrganization(
    params: AdminCreateOrganizationParams,
  ): Promise<AdminCreateOrganizationResponse> {
    return this.http.post<AdminCreateOrganizationResponse>(
      "/admin/organizations",
      params,
      {
        headers: this.headers(),
  ...
  async updateOrganization(
    id: string,
    params: AdminUpdateOrganizationParams,
  ...
  async deleteOrganization(
    id: string,
    params?: AdminDeleteOrganizationParams,
  ): Promise<void> {
    const qp:
      | Record<string, string | number | boolean | undefined>
      | undefined = params ? { hardDelete: params.hardDelete } : undefined;
  ...
  async createApiKey(
    orgId: string,
    params: AdminCreateApiKeyParams,
  ): Promise<AdminApiKeyResponse> {
    return this.http.post<AdminApiKeyResponse>(
  ...
  async resetUsage(orgId: string): Promise<void> {
    await this.http.post<void>(
      `/admin/organizations/${orgId}/reset-usage`,
      undefined,
      {
        headers: this.headers(),
      },
