...
describe("WorkflowsResource", () => {
  ...
  describe("create", () => {
    it("should create a workflow", async () => {
      ...
      server.use(
        http.post(
          "https://api.spooled.cloud/api/v1/workflows",
          async ({ request }) => {
  ...
  describe("cancel", () => {
    it("should cancel a workflow", async () => {
      server.use(
        http.post(
          "https://api.spooled.cloud/api/v1/workflows/workflow_123/cancel",
          () => {
            return HttpResponse.json({
              id: "workflow_123",
              name: "My Workflow",
  ...
  describe("retry", () => {
    it("should retry a failed workflow", async () => {
      server.use(
        http.post(
          "https://api.spooled.cloud/api/v1/workflows/workflow_123/retry",
          () => {
            return HttpResponse.json({
              id: "workflow_123",
              name: "My Workflow",
  ...
  describe("job dependencies", () => {
    it("should get job dependencies", async () => {
      server.use(
        http.get(
          "https://api.spooled.cloud/api/v1/jobs/job_123/dependencies",
          () => {
            return HttpResponse.json({
              job_id: "job_123",
              status: "pending",
