...
describe("WebhooksResource", () => {
  ...
  describe("create", () => {
    it("should create a webhook", async () => {
      ...
      server.use(
        http.post(
          "https://api.spooled.cloud/api/v1/outgoing-webhooks",
          async ({ request }) => {
  ...
  describe("get", () => {
    it("should get a webhook", async () => {
      server.use(
        http.get(
          "https://api.spooled.cloud/api/v1/outgoing-webhooks/webhook_123",
          () => {
            return HttpResponse.json({
              id: "webhook_123",
              organization_id: "org_123",
  ...
  describe("test", () => {
    it("should test a webhook", async () => {
      server.use(
        http.post(
          "https://api.spooled.cloud/api/v1/outgoing-webhooks/webhook_123/test",
          () => {
            return HttpResponse.json({
              success: true,
              status_code: 200,
  ...
  describe("getDeliveries", () => {
    it("should get webhook deliveries", async () => {
      server.use(
        http.get(
          "https://api.spooled.cloud/api/v1/outgoing-webhooks/webhook_123/deliveries",
          () => {
            return HttpResponse.json([
              {
                id: "delivery_1",
