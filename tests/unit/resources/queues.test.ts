...
describe("QueuesResource", () => {
  ...
  describe("get", () => {
    ...
    it("should URL-encode queue name", async () => {
      ...
      server.use(
        http.get(
          "https://api.spooled.cloud/api/v1/queues/my%2Fqueue",
          ({ request }) => {
  ...
  describe("updateConfig", () => {
    it("should update queue config", async () => {
      ...
      server.use(
        http.put(
          "https://api.spooled.cloud/api/v1/queues/my-queue/config",
          async ({ request }) => {
  ...
  describe("getStats", () => {
    it("should get queue stats", async () => {
      server.use(
        http.get(
          "https://api.spooled.cloud/api/v1/queues/my-queue/stats",
          () => {
            return HttpResponse.json({
              queue_name: "my-queue",
              pending_jobs: 100,
  ...
  describe("pause", () => {
    it("should pause a queue", async () => {
      ...
      server.use(
        http.post(
          "https://api.spooled.cloud/api/v1/queues/my-queue/pause",
          async ({ request }) => {
            receivedBody = await request.json();
            return HttpResponse.json({
              queue_name: "my-queue",
  ...
  describe("resume", () => {
    it("should resume a queue", async () => {
      server.use(
        http.post(
          "https://api.spooled.cloud/api/v1/queues/my-queue/resume",
          () => {
            return HttpResponse.json({
              queue_name: "my-queue",
              resumed: true,
