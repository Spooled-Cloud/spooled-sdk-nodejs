...
describe("SchedulesResource", () => {
  ...
  describe("create", () => {
    ...
    it("should send correct request body", async () => {
      ...
      expect(receivedBody.payload_template).toEqual({
  ...
  describe("delete", () => {
    it("should delete a schedule", async () => {
      ...
      const client = createClient();
      await expect(
        client.schedules.delete("schedule_123"),
  ...
  describe("pause", () => {
    it("should pause a schedule", async () => {
      server.use(
        http.post(
          "https://api.spooled.cloud/api/v1/schedules/schedule_123/pause",
          () => {
            return HttpResponse.json({
              id: "schedule_123",
              organization_id: "org_123",
  ...
  describe("resume", () => {
    it("should resume a schedule", async () => {
      server.use(
        http.post(
          "https://api.spooled.cloud/api/v1/schedules/schedule_123/resume",
          () => {
            return HttpResponse.json({
              id: "schedule_123",
              organization_id: "org_123",
  ...
  describe("trigger", () => {
    it("should trigger a schedule", async () => {
      server.use(
        http.post(
          "https://api.spooled.cloud/api/v1/schedules/schedule_123/trigger",
          () => {
            return HttpResponse.json({
              job_id: "job_456",
  ...
  describe("getHistory", () => {
    it("should get schedule history", async () => {
      server.use(
        http.get(
          "https://api.spooled.cloud/api/v1/schedules/schedule_123/history",
          () => {
            return HttpResponse.json([
              {
                id: "run_1",
